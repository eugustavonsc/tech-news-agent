        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    f"Se o texto recebido NÃO for genuinamente sobre tecnologia "
                    f"(ex: só cita a palavra 'tecnologia' de passagem, mas é sobre "
                    f"economia, esporte, política, acidentes, agropecuária etc.), "
